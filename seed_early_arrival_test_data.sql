...
-- ------------------------------------------------------------------------
INSERT INTO bookings (id, booking_code, user_id, vehicle_id, scheduled_start_time, expected_end_time, status, total_price, qr_content, qr_used, is_late, arrived_at, created_at, updated_at, bay_number) 
VALUES (201, 'BK-TEST-EARLY-ARRIVED', 4, 1, NOW() + INTERVAL '3 hours', NOW() + INTERVAL '3 hours 45 minutes', 'ARRIVED', 120000, 'AUTOWASH|BOOKING|BK-TEST-EARLY-ARRIVED|201', true, false, NOW(), NOW(), NOW(), NULL);
...
VALUES (201, 201, 'PAID', 'CASH', 120000, 0, 120000, NOW(), NOW(), NOW());

-- ------------------------------------------------------------------------
-- 2. BOOKING ID 202: Đặt lịch CONFIRM (Lịch 2 tiếng sau, chưa Check-in)
-- ------------------------------------------------------------------------
INSERT INTO bookings (id, booking_code, user_id, vehicle_id, scheduled_start_time, expected_end_time, status, total_price, qr_content, qr_used, is_late, arrived_at, created_at, updated_at, bay_number) 
VALUES (202, 'BK-TEST-EARLY-CONFIRM', 5, 2, NOW() + INTERVAL '2 hours', NOW() + INTERVAL '2 hours 45 minutes', 'CONFIRM', 150000, 'AUTOWASH|BOOKING|BK-TEST-EARLY-CONFIRM|202', false, false, NOW(), NOW(), NOW(), NULL);

INSERT INTO booking_details (id, booking_id, service_price_id, actual_price, actual_duration_minutes)
VALUES (202, 202, 2, 150000, 45);

INSERT INTO payments (id, booking_id, payment_status, payment_method, sub_total, discount_amount, final_price, paid_at, created_at, updated_at) 
VALUES (202, 202, 'PAID', 'PAYOS', 150000, 0, 150000, NOW(), NOW(), NOW());
