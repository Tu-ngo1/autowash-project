...
--   Note: included 'is_late' = false to satisfy the NOT NULL constraint on 'bookings' table.
-- ============================================================================
...
INSERT INTO bookings (
    ...
    status, total_price, qr_content, qr_used, is_late, created_at, updated_at,
    ...
    'CONFIRM', 100000, 'AUTOWASH|BOOKING|BK-CANCEL-PENDING|777f9999-55cc-4372-a567-0e02b2c3d999', false, false, NOW(), NOW(),
...
INSERT INTO bookings (
    ...
    'CANCELLED', 180000, 'AUTOWASH|BOOKING|BK-CANCEL-APPROVED|888f9999-55cc-4372-a567-0e02b2c3d888', true, false, NOW() - INTERVAL '2 days', NOW(),
...
INSERT INTO bookings (
    ...
    'CONFIRM', 100000, 'AUTOWASH|BOOKING|BK-CANCEL-REJECTED|999f9999-55cc-4372-a567-0e02b2c3d777', false, false, NOW(), NOW(),
